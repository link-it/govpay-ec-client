...
3. Verifica che il projectKey sia: `link-it_govpay-ec-client`
...
```markdown
[![Java CI with Maven](https://github.com/link-it/govpay-ec-client/actions/workflows/maven.yml/badge.svg)](https://github.com/link-it/govpay-ec-client/actions/workflows/maven.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=link-it_govpay-ec-client&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=link-it_govpay-ec-client)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=link-it_govpay-ec-client&metric=coverage)](https://sonarcloud.io/summary/new_code?id=link-it_govpay-ec-client)
```
