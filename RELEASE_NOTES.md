...
- **Parent POM `govpay-bom` allineato alla 2.0.3** (era 2.0.1). Principale aggiornamento portato dal BOM: **Jackson 3.1.4 → 3.2.1**. Spring Boot 4.1.0, Spring Framework 7.0.8 e OWASP Dependency-Check 12.2.2 restano invariati.
